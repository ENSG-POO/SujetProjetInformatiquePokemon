	    ...
	    public static void main(String[] args) {
	        ...
	        button.addActionListener(new ActionListener() {
	            public void actionPerformed(ActionEvent e) {
	                // Modification de la variable en utilisant l'instance de Main
	                mainInstance.variableAModifier += 10;
	                System.out.println("La variable a été modifiée : " + mainInstance.variableAModifier);
	            }
	        });
