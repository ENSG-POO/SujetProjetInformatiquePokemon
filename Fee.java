...
public class Fee {
	...
	public static final String[] Efficace= {"Combat","Dragon","Tenebres"};
	public static final String[] PasEfficace= {"Acier","Poison","Feu"};
	public static final String[] Neutre= {"Insecte","Normal","Electrique"
	,"Plante","Poison","Psy","Sol","Spectre","Vol"
	,"Fee","Glace","Roche"};
