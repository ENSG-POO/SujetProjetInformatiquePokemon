...
public class Feu {
	...
	public static final String[] Efficace= {"Acier","Plante","Insecte","Glace"};
	public static final String[] PasEfficace= {"Feu","Dragon","Eau","Roche"};
	public static final String[] Neutre= {"Sol","Combat","Electrique","Fee"
			,"Normal","Poison","Psy","Spectre","Tenebres","Vol"};
	...
	public static double Attaque(String typeAdv1,String typeAdv2) {
		...
		if ( contains(typeAdv1, PasEfficace) && contains(typeAdv2, PasEfficace) ) {
			System.out.println(" Pas du tout Efficace ");
			return 0.25;			
		}	// 2 faiblesses
