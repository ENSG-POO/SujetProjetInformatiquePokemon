...
public class Combat {
	...
	public static final String[] Efficace= {"Acier","Glace","Normal","Roche","Tenebres"};
	public static final String[] PasEfficace= {"Fee","Insecte","Poison","Psy","Vol"};
	public static final String[] Neutre= {"Combat","Dragon","Eau","Electrique","Feu"
			,"Plante","Sol"};
