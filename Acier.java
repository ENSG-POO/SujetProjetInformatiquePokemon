...
public class Acier {
	...
	public static final String[] Efficace= {"Fee","Glace","Roche"};
	public static final String[] PasEfficace= {"Acier","Eau","Electrique","Feu"};
	public static final String[] Neutre= {"Combat","Dragon","Insecte","Normal"
	,"Plante","Poison","Psy","Sol","Spectre","Tenebres","Vol"};
