...
public class Vol {
	...
	public static final String[] Efficace= {"Combat","Insecte","Plante"};
	public static final String[] PasEfficace= {"Acier","Electrique","Roche"};
	public static final String[] Neutre= {"Fee","Glace","Dragon","Normal"
	,"Poison","Psy","Sol","Spectre","Tenebres","Eau","Vol","Feu"};
