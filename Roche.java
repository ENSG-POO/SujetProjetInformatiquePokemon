...
public class Roche {
	...
	public static final String[] Efficace= {"Glace","Feu","Vol","Insecte"};
	public static final String[] PasEfficace= {"Acier","Combat","Sol"};
	public static final String[] Neutre= {"Fee","Dragon","Normal","Eau","Electrique"
	,"Plante","Poison","Psy","Spectre","Tenebres","Roche"};
