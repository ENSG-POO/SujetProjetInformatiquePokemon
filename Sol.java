...
public class Sol {
	...
	public static final String[] Efficace= {"Acier","Electrique","Poison","Roche","Feu"};
	public static final String[] PasEfficace= {"Insecte","Plante"};
	public static final String[] Neutre= {"Fee","Combat","Dragon","Eau","Normal"
	,"Glace","Psy","Sol","Spectre","Tenebres"};
