...
public class Sol {
	...
	public static final String[] Efficace= {"Acier","Roche","Feu","Electrique","Poison"};
	public static final String[] PasEfficace= {"Plante","Insecte"};
	public static final String[] Neutre= {"Dragon","Combat","Fee","Normal"
			,"Psy","Spectre","Tenebres","Sol","Eau","Glace"};
	public static final String[] Inefficace= {"Vol"};
...
public static String choix_attaque(int HP, int attaque , int defense ,String typeDef) {
    ...
    while(!(Attaque.equals("neutre")) && !(Attaque.equals("typé")) ){
        ...
        System.out.println("conseil : " + Sol.Efficacite(typeDef));
        Attaque = input2.next();
    }
 // boucle qui permet de forcer l'utilisateur a faire un des choix propose
    if (Attaque.equals("typé")) {
	    return Sol.ResultatHP( attaque , HP , defense , typeDef);
    }
    else {
