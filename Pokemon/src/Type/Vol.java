...
public class Vol {
	public static final String[] Efficace= {"Plante","Combat","Insecte"};
	public static final String[] PasEfficace= {"Roche","Acier","Electrique"};
	public static final String[] Neutre= {"Sol","Eau","Fee","Glace","Normal","Psy","Spectre","Tenebres","Dragon","Vol","Feu"
			,"Poison"};
...
public static String choix_attaque(int HP, int attaque , int defense ,String typeDef) {
    ...
    while(!(Attaque.equals("neutre")) && !(Attaque.equals("typé")) ){
        ...
        System.out.println("conseil : " + Vol.Efficacite(typeDef));
        Attaque = input2.next();
    }
 // boucle qui permet de forcer l'utilisateur a faire un des choix propose
    if (Attaque.equals("typé")) {
	    return Vol.ResultatHP( attaque , HP , defense , typeDef);
    }
    else {
