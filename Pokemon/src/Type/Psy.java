...
public class Psy {
	...
	public static final String[] Efficace= {"Poison","Combat"};
	public static final String[] PasEfficace= {"Acier","Psy"};
	public static final String[] Neutre= {"Roche","Sol","Eau","Fee","Glace","Electrique","Insecte"
			,"Normal","Spectre","Dragon","Vol","Plante","Feu"};
	public static final String[] Inefficace= {"Tenebres"};
...
public static String choix_attaque(int HP, int attaque , int defense ,String typeDef) {
    ...
    while(!(Attaque.equals("neutre")) && !(Attaque.equals("typé")) ){
        ...
        System.out.println("conseil : " + Psy.Efficacite(typeDef));
        Attaque = input2.next();
    }
 // boucle qui permet de forcer l'utilisateur a faire un des choix propose
    if (Attaque.equals("typé")) {
	    return Psy.ResultatHP( attaque , HP , defense , typeDef);
    }
    else {
