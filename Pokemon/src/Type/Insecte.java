...
public class Insecte {
	...
	public static final String[] Efficace= {"Tenebres","Plante"};
	public static final String[] PasEfficace= {"Acier","Combat","Vol","Feu","Fee"
			,"Poison","Spectre"};
	public static final String[] Neutre= {"Roche","Sol","Eau","Dragon","Glace","Electrique","Insecte"
			,"Normal","Psy"};
...
public static String choix_attaque(int HP, int attaque , int defense ,String typeDef) {
    ...
    while(!(Attaque.equals("neutre")) && !(Attaque.equals("typé")) ){
        ...
        System.out.println("conseil : " + Insecte.Efficacite(typeDef));
        Attaque = input2.next();
    }
 // boucle qui permet de forcer l'utilisateur a faire un des choix propose
    if (Attaque.equals("typé")) {
	    return Insecte.ResultatHP( attaque , HP , defense , typeDef);
    }
    else {
