...
public class Glace {
	...
	public static final String[] Efficace= {"Vol","Dragon","Sol","Plante"};
	public static final String[] PasEfficace= {"Acier","Eau","Feu","Glace"};
	public static final String[] Neutre= {"Combat","Insecte","Normal","Electrique"
	,"Poison","Psy","Spectre","Tenebres","Fee","Roche"};
...
public static String choix_attaque(int HP, int attaque , int defense ,String typeDef) {
    ...
    while(!(Attaque.equals("neutre")) && !(Attaque.equals("typé")) ){
        ...
        System.out.println("conseil : " + Glace.Efficacite(typeDef));
        Attaque = input2.next();
    }
 // boucle qui permet de forcer l'utilisateur a faire un des choix propose
    if (Attaque.equals("typé")) {
	    return Glace.ResultatHP( attaque , HP , defense , typeDef);
    }
    else {
