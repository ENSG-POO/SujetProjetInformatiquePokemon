...
public class Spectre {
	...
	public static final String[] Efficace= {"Psy","Spectre"};
	public static final String[] PasEfficace= {"Tenebres"};
	public static final String[] Neutre= {"Roche","Sol","Eau","Combat","Fee","Glace"
			,"Electrique","Insecte","Acier","Dragon","Vol","Plante","Feu","Poison"};
	public static final String[] Inefficace= {"Normal"};
...
public static String choix_attaque(int HP, int attaque , int defense ,String typeDef) {
    ...
    while(!(Attaque.equals("neutre")) && !(Attaque.equals("typé")) ){
        ...
        System.out.println("conseil : " + Spectre.Efficacite(typeDef));
        Attaque = input2.next();
    }
 // boucle qui permet de forcer l'utilisateur a faire un des choix propose
    if (Attaque.equals("typé")) {
	    return Spectre.ResultatHP( attaque , HP , defense , typeDef);
    }
    else {
