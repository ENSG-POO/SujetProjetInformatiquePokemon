...
public class Plante {
	...
	public static final String[] Efficace= {"Roche","Sol","Eau"};
	public static final String[] PasEfficace= {"Acier","Dragon","Vol","Plante","Feu"
			,"Poison"};
	public static final String[] Neutre= {"Combat","Fee","Glace","Electrique","Insecte"
			,"Normal","Psy","Spectre","Tenebres"};
...
public static String choix_attaque(int HP, int attaque , int defense ,String typeDef) {
    ...
    while(!(Attaque.equals("neutre")) && !(Attaque.equals("typé"))){
        ...
        System.out.println("conseil : " + Plante.Efficacite(typeDef));
        Attaque = input2.next();
    }
 // boucle qui permet de forcer l'utilisateur a faire un des choix propose
    if (Attaque.equals("typé")) {
	    return Plante.ResultatHP( attaque , HP , defense , typeDef);
    }
    else {
