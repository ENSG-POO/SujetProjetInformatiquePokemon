...
public class Tenebres {
	
	public static final String[] Efficace= {"Psy","Spectre"};
	public static final String[] PasEfficace= {"Combat","Fee","Tenebres"};
	public static final String[] Neutre= {"Glace","Electrique","Insecte","Normal"
			,"Roche","Sol","Eau","Acier","Dragon","Vol","Plante","Feu","Poison"};
...
public static String choix_attaque(int HP, int attaque , int defense ,String typeDef) {
    ...
    while(!(Attaque.equals("neutre")) && !(Attaque.equals("typé")) ){
        ...
        System.out.println("conseil : " + Tenebres.Efficacite(typeDef));
        Attaque = input2.next();
    }
 // boucle qui permet de forcer l'utilisateur a faire un des choix propose
    if (Attaque.equals("typé")) {
	    return Tenebres.ResultatHP( attaque , HP , defense , typeDef);
    }
    else {
