...
public class Combat {
	...
	public static final String[] Efficace= {"Acier","Roche","Glace","Normal","Tenebres"};
	public static final String[] PasEfficace= {"Psy","Vol","Fee","Insecte","Poison"};
	public static final String[] Neutre= {"Dragon","Sol","Eau","Plante","Feu",
			"Combat","Electrique"};
...
public static String choix_attaque(int HP, int attaque , int defense ,String typeDef) {
    ...
    while(!(Attaque.equals("neutre")) && !(Attaque.equals("typé")) ){
        ...
        System.out.println("conseil : " + Combat.Efficacite(typeDef));
        Attaque = input2.next();
    }
 // boucle qui permet de forcer l'utilisateur a faire un des choix propose
    if (Attaque.equals("typé")) {
	    return Combat.ResultatHP( attaque , HP , defense , typeDef);
    }
    else {
