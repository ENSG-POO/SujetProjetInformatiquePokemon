...
public class Roche {
	...
	public static final String[] Efficace= {"Feu","Glace","Insecte","Vol"};
	public static final String[] PasEfficace= {"Acier","Sol","Combat"};
	public static final String[] Neutre= {"Roche","Eau","Fee","Electrique"
			,"Normal","Psy","Spectre","Tenebres","Dragon","Plante","Poison"};
...
public static String choix_attaque(int HP, int attaque , int defense ,String typeDef) {
    ...
    while(!(Attaque.equals("neutre")) && !(Attaque.equals("typé")) ){
        ...
        System.out.println("conseil : " + Roche.Efficacite(typeDef));
        Attaque = input2.next();
    }
 // boucle qui permet de forcer l'utilisateur a faire un des choix propose
    if (Attaque.equals("typé")) {
	    return Roche.ResultatHP( attaque , HP , defense , typeDef);
    }
    else {
