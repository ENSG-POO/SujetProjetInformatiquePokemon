...
public class Eau {
	...
	public static final String[] Efficace= {"Roche","Sol","Feu"};
	public static final String[] PasEfficace= {"Dragon","Plante","Eau"};
	public static final String[] Neutre= {"Acier","Combat","Fee","Glace"
			,"Electrique","Insecte","Normal","Psy","Spectre","Tenebres"
			,"Vol","Poison"};
...
public static String choix_attaque(int HP, int attaque , int defense ,String typeDef) {
    ...
    while(!(Attaque.equals("neutre")) && !(Attaque.equals("typé")) ){
        ...
        System.out.println("conseil : " + Eau.Efficacite(typeDef));
        Attaque = input2.next();
    }
 // boucle qui permet de forcer l'utilisateur a faire un des choix propose
    if (Attaque.equals("typé")) {
	    return Eau.ResultatHP( attaque , HP , defense , typeDef);
    }
    else {
