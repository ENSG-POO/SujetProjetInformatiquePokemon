...
public class ControlePanel extends JPanel {
	...
	public ControlePanel(CartePanel cartePanel) {
		...
		JButton clic = new JButton("allez au centre du soin");
		...
		clic.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				cartePanel.ajoutMessage("tapez 2!");
				
			}
		});
				
				// construire le bouton commencer le combat
				JButton clic1 = new JButton("choix attaque");
				clic1.setBounds(100, 100, 50, 200);
				this.add(clic1);  
				clic1.setVisible(true);
		// On ajoute un évènement sur le bouton
			clic1.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
				cartePanel.ajoutMessage(" entre attaque spécial et attaque neutre");
				}
			});
