...
public class Tenebres {
	...
	public static final String[] PasEfficace= {"Combat","Fee","Roche"};
	public static final String[] Neutre= {"Glace","Dragon","Insecte","Normal","Plante"
			,"Poison","Acier","Eau","Electrique","Feu","Sol"
			,"Tenebres","Vol"};
