...
public class Eau {
	...
	public static final String[] Efficace= {"Feu","Sol","Roche"};
	public static final String[] PasEfficace= {"Dragon","Eau","Plante"};
	public static final String[] Neutre= {"Acier","Combat","Electrique","Fee"
			,"Insecte","Normal","Poison","Psy","Spectre"
			,"Tenebres","Vol"};
